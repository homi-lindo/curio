...
Este documento concentra o conteúdo técnico do projeto: escopo detalhado,
arquitetura, comandos, sync self-hosted, prontidão de loja e pendências. A
apresentação do app vive no [README](../README.md).
